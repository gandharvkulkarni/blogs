...
const StylishButton = ({text}) => {
    return (
        <button
            class="group relative flex flex-row items-center bg-[#212121] rounded-lg justify-center gap-2 px-4 py-1.5 text-sm font-medium shadow-[inset_0_-8px_10px_#8fdfff1f] transition-shadow duration-500 ease-out hover:shadow-[inset_0_-5px_10px_#8fdfff3f]"
        >
            <div
